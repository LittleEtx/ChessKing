...
public class DeleteReplayPopOut extends SubScene {

    public DeleteReplayPopOut(Replay replay) {
        Rectangle bg = new Rectangle(1200,800, Color.web("#00000080"));
        getContentRoot().getChildren().add(bg);

        String text = "Delete this replay?";
        var deleteReplayText = getUIFactoryService().newText(text, Color.BROWN,35);
        ...
        VBox buttonsBg = new VBox(30,deleteReplayText,buttons);
