...
public class GameInfo implements Serializable {
    ...
    public GameInfo(Player player1, Player player2, GameState gameState, double gameTime, double turnTime) {
    ...
    public GameInfo(Player player1, double gameTime, double turnTime) {
        this.player1 = player1;
        this.gameTime = gameTime;
        this.turnTime = turnTime;
    }
