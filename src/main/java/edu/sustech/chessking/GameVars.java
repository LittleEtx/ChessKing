...
public class GameVars {
    public static final String GameCoreVar = "core";
    public static final String DownChessSkinVar = "downChessSkin";
    public static final String UpChessSkinVar = "upChessSkin";
    public static final String DownSideColorVar = "downSideColor";
    public static final String GameTypeVar = "gameType";
